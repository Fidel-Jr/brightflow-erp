...
namespace asp_backend.Migrations
{
    ...
    [Migration("20260228010204_UpdateOrderStatusDT")]
    partial class UpdateOrderStatusDT
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("asp_backend.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("asp_backend.Models.DriverVehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_driver_vehicles");

                    b.HasIndex("DriverId")
                        .HasDatabaseName("ix_driver_vehicles_driver_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("asp_backend.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("asp_backend.Models.DriverVehicle", b =>
                {
                    b.HasOne("asp_backend.Models.ApplicationUser", "Driver")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_driver_vehicles_application_user_driver_id");
